...
## Design
- `--primary: 217 91% 20%` (navy - autoridad técnica) / dark: `217 91% 60%`
- `--background: 0 0% 100%` (white - claridad máxima) / dark: `217 33% 10%`
- `--foreground: 217 33% 17%` (dark slate) / dark: `0 0% 97.5%`
- `--accent: 38 92% 50%` (amber - señalización) / dark: `38 92% 60%`
- `--muted: 217 20% 95%` (light blue-gray) / dark: `217 20% 20%`
- Headings: JetBrains Mono (precisión técnica)
...
- Simulaciones interactivas arrastrables en canvas HTML5
- 26 ejercicios resueltos paso a paso (problemas 17-42)
