...
export default function QuizPage() {
  ...
  const quizOptions = [
    ...
    },
    {
      ...
      icon: RotateCw,
      questions: quizByTopic["Momentos y Torque"],
      color: "text-red-600 dark:text-red-400",
      bgColor: "bg-red-100 dark:bg-red-950",
      count: quizByTopic["Momentos y Torque"].length,
    },
    {
      id: "maquinas",
      ...
      icon: Settings,
      questions: quizByTopic["Máquinas Simples"],
      color: "text-cyan-600 dark:text-cyan-400",
      bgColor: "bg-cyan-100 dark:bg-cyan-950",
      count: quizByTopic["Máquinas Simples"].length,
    },
  ];
